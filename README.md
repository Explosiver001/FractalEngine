...
- Vyberte **Mandelbrot/Julia** pro prozkoumání fraktálů. Kolečkem myši přibližujte, tažením posouvejte a pomocí ovládacích prvků měňte počet iterací, exponent, barvy přechodu, barvu vnitřku fraktálu a obrysy.
- Vyberte **Attractor** pro generování chaotických obrazců. Upravte parametry `a/b/c/d`, jas a gammu nebo klikněte na náhodný výběr a objevujte nové tvary.
